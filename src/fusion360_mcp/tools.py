    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "library_name": {
                    "type": "string",
                    "description": "Name of the specific local library to target, e.g. 'Pinchy' or 'Library'. Only used when target='local'. If omitted, uses the first available local library.",
                },
            },
        },
    },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "library_name": {"type": "string", "description": "Name of the local library to search, e.g. 'Pinchy'. If omitted, searches the first available local library."},
            },
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "library_name": {
                    "type": "string",
                    "description": "Filter to a specific named library, e.g. 'Pinchy'. Only relevant for location='local'.",
                },
            },
        },
    },
